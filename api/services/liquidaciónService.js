...
async function guardarLiquidacionesHistoricas({ tipo, fecha, usuarioId, totalGeneral }) {
  ...
  `;
    ...
    SELECT
      l.ID, l.LIQ_NUMC, l.LIQ_FPROC, l.LIQ_FCOM, l.LIQ_APPR, l.LIQ_NUMTA, l.LIQ_MONTO, l.LIQ_TXS, 
      l.LIQ_CPRI, l.LIQ_MARC, l.LIQ_FEDI, l.LIQ_NRO_UNICO, l.LIQ_CEIC, l.LIQ_CAD_CADIVA, 
      l.LIQ_DEIC, l.LIQ_DCOAD_IVCOM, l.LIQ_PREPAGO, l.LIQ_NOMBRE_BANCO, l.LIQ_TIPO_CUENTA_BANCO, 
      l.LIQ_NUMERO_CUENTA_BANCO, l.LIQ_MONEDA_CUENTA_BANCO 
    FROM
      LIQUIDACION_FILE_TBK l
    ${whereClause}
